...
/**
 * Compiled with `make`
 * Valgrind with: `valgrind --track-origins=yes --leak-check=full ./a.out -s 10 -f < ./in/test1.in` // testn.in for all tests
 * Tested with `make && make 1 && make 2 && make 3 && make 4 && make 5 && make 6 && make 7 && make 8 && make 9 && make 10` // All worked :)
 */
